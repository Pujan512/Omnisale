                        ...
                        return <tr key={index}>
                            ...
                            {!product.isSold && <>
                                <td>
                                    ...
                                    <button onClick={() => navigate('/EditProd/' + product.id)} className="lg:hidden text-blue-400 p-2">
                                ...
                                <td>
                                    ...
                                    <button onClick={() => navigate('/EditProd/' + product.id)} className="lg:hidden text-red-500 p-2"><svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="currentColor" className="bi bi-trash lg:hidden" viewBox="0 0 16 16">
